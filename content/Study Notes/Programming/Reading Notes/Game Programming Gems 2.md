...
... There's more points on this articles, but I will take the following list:
...
- World: The total area in which the game takes place; internally a 2D array of tiles, also called the map. 
- Player: A human or computer entity who controls a population of units. Each player has a unique set of visibility information. 
- Unit: Any game entity that is owned or controlled by a player. It does not have to be movable. 
- Line-of-Sight (LOS): The area around a unit that is currently visible because of its presence. 
